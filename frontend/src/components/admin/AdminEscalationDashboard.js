                        ...
                        <div className="row">
                            <div className="col-md-4">
                                <button 
                                    ...
                                    onClick={() => window.location.href = '/admin/escalation/config'}
                                >
                                    ⚙️ Configure Escalation
                                </button>
                            </div>
                            <div className="col-md-4">
                                <button 
                                    className="btn btn-warning w-100 mb-2"
                                    onClick={() => window.location.href = '/admin/escalation/high-priority'}
                                >
                            ...
                            <div className="col-md-4">
                                <button 
                                    ...
                                    onClick={() => window.location.href = '/admin/escalation/run-now'}
                                >
                                    ▶️ Run Escalation Now
                                </button>
                            </div>
                        </div>
                    </div>
