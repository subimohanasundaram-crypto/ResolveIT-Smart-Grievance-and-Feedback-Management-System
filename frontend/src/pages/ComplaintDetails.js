    ...
    useEffect(() => {
        const fetchComplaintDetails = async () => {
            try {
                ...
                console.log(`👤 User fetching complaint ${id} details...`);
                ...
                if (response.data.success) {
                    ...
                    const foundComplaint = userComplaints.find(c => c.id == id);
                    ...
                    if (foundComplaint) {
                        ...
                        try {
                            ...
                            console.log('📝 User comments response:', commentsResponse.data);

                            if (commentsResponse.data.success) {
                                setComments(commentsResponse.data.data || []);
                                console.log(`✅ User loaded ${commentsResponse.data.data?.length || 0} PUBLIC comments`);
                            }
                        } catch (commentsError) {
                            console.log('⚠️ Could not fetch comments:', commentsError.message);
                            setComments([]);
                        }
                    } else {
                ...
                console.error('❌ Error in user complaint view:', error);
